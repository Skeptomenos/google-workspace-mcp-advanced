...
from auth.redirect_policy import build_allowed_local_redirect_uris, build_local_redirect_uri
...
class MinimalOAuthServer:
    ...
    def __init__(self, port: int, base_uri: str = "http://localhost"):
        ...
        self.redirect_uri = build_local_redirect_uri(base_uri, port)
        self.app = FastAPI()
...
def start_oauth_callback_server(
    ...
    allowed_redirect_uris = build_allowed_local_redirect_uris(base_uri, preferred_ports)
